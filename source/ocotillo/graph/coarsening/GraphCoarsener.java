...
public abstract class GraphCoarsener {
	...
	public void computeCoarsening() {
		...
		while(!breakCondition && !stoppingCondition()) {
			...
			coarserGraph.nodeAttribute(StdAttribute.weight).merge(subgraph.nodeAttribute(StdAttribute.weight));
			coarserGraph.edgeAttribute(StdAttribute.weight).merge(subgraph.edgeAttribute(StdAttribute.weight));
					
			enclosedSubgraph.nodeAttribute(StdAttribute.weight).copy(coarserGraph.nodeAttribute(StdAttribute.weight));
			enclosedSubgraph.edgeAttribute(StdAttribute.weight).copy(coarserGraph.edgeAttribute(StdAttribute.weight));
